...
namespace TitaniumWindows
{
	...
	FilesystemModule::~FilesystemModule() { TITANIUM_LOG_DEBUG("TitaniumWindows::FilesystemModule::dtor"); }
	...
	{
		const auto script = "			 var path = [Ti.Filesystem.tempDirectory, +new Date()];"
