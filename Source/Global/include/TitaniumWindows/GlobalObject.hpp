...
namespace TitaniumWindows
{
	...
	/*!
	  ...
	  Windows.
	*/
	class TITANIUMWINDOWS_GLOBAL_EXPORT GlobalObject final : public Titanium::GlobalObject,
	                                                         public JSExport<GlobalObject>
	{
	   public:
	   ...
	   protected:
		...
		virtual std::shared_ptr<Titanium::GlobalObject::Timer> CreateTimer(
		    Callback_t callback, const std::chrono::milliseconds& interval) const TITANIUM_NOEXCEPT override final;
