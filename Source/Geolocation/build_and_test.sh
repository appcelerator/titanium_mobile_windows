...
declare -r TitaniumWindows_Geolocation_DISABLE_TESTS="OFF"
...
cmd+=" -DTitaniumWindows_Geolocation_DISABLE_TESTS=${TitaniumWindows_Geolocation_DISABLE_TESTS}"
...
if [ "${TitaniumWindows_Geolocation_DISABLE_TESTS}" != "ON" ]; then
