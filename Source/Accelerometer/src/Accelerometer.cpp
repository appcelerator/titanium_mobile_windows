...
{
Accelerometer::Accelerometer(const JSContext& js_context) TITANIUM_NOEXCEPT : Titanium::Accelerometer(js_context)
{
...
void Accelerometer::enableEvent(const std::string& event_name) TITANIUM_NOEXCEPT
{
	...
	if (event_name == "update") {
		...
		update_event_ = accelerometer_->ReadingChanged += ref new Windows::Foundation::TypedEventHandler<
