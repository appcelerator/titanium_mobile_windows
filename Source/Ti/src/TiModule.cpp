...
{
TiModule::TiModule(const JSContext& js_context) TITANIUM_NOEXCEPT : Titanium::TiModule(js_context)
{
...
TiModule::~TiModule() { TITANIUM_LOG_DEBUG("TitaniumWindows::TiModule::dtor"); }
...
std::string TiModule::version() const TITANIUM_NOEXCEPT { return "__TITANIUM_VERSION__"; }

std::string TiModule::buildDate() const TITANIUM_NOEXCEPT { return "__TITANIUM_BUILD_DATE__"; }

std::string TiModule::buildHash() const TITANIUM_NOEXCEPT { return "__TITANIUM_BUILD_HASH__"; }
