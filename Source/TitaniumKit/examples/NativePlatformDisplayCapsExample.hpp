 ...
 */
class NativePlatformDisplayCapsExample final : public Titanium::Platform::DisplayCaps,
                                               public JSExport<NativePlatformDisplayCapsExample>
{
   public:
	NativePlatformDisplayCapsExample(const JSContext& js_context) TITANIUM_NOEXCEPT;
	NativePlatformDisplayCapsExample(const NativePlatformDisplayCapsExample&,
