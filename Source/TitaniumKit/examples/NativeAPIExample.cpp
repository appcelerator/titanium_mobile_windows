...
NativeAPIExample::NativeAPIExample(const JSContext& js_context) TITANIUM_NOEXCEPT : Titanium::API(js_context)
{
...
NativeAPIExample::~NativeAPIExample() TITANIUM_NOEXCEPT { TITANIUM_LOG_DEBUG("NativeAPIExample:: dtor ", this); }
