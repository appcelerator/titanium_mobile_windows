...
std::string NativeGlobalObjectExample::get_example_resource() const TITANIUM_NOEXCEPT { return example_resource__; }
...
{
   public:
	NativeGlobalObjectTimerExample(Titanium::GlobalObject::Callback_t callback,
	...
	virtual ~NativeGlobalObjectTimerExample() { TITANIUM_LOG_DEBUG("NativeGlobalObjectTimerExample: dtor"); }
	...
	virtual void Stop() TITANIUM_NOEXCEPT override final { TITANIUM_LOG_DEBUG("NativeGlobalObjectTimerExample::Stop"); }

   private:
	Titanium::GlobalObject::Callback_t callback__;
};

std::shared_ptr<Titanium::GlobalObject::Timer> NativeGlobalObjectExample::CreateTimer(
    Titanium::GlobalObject::Callback_t callback, const std::chrono::milliseconds& interval) const TITANIUM_NOEXCEPT
{
...
NativeGlobalObjectExample::NativeGlobalObjectExample(const NativeGlobalObjectExample& rhs,
