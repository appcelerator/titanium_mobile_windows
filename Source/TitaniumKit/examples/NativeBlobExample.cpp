...
NativeBlobExample::NativeBlobExample(const JSContext& js_context) TITANIUM_NOEXCEPT : Titanium::Blob(js_context) {}

NativeBlobExample::NativeBlobExample(const NativeBlobExample& rhs,
