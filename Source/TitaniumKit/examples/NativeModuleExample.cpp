...
NativeModuleExample::NativeModuleExample(const NativeModuleExample& rhs,
...
JSValue NativeModuleExample::get_enabled() const { return enabled__; }

std::string NativeModuleExample::get_event_name() const TITANIUM_NOEXCEPT { return event_name__; }

void NativeModuleExample::set_event_name(const std::string& event_name) TITANIUM_NOEXCEPT { event_name__ = event_name; }
