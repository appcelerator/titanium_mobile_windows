...
NativeViewExample::NativeViewExample(const JSContext& js_context) TITANIUM_NOEXCEPT : Titanium::UI::View(js_context)
{
	TITANIUM_LOG_DEBUG("NativeViewExample:: ctor 1 ", this);
}

NativeViewExample::NativeViewExample(const NativeViewExample& rhs,
...
NativeViewExample::~NativeViewExample() TITANIUM_NOEXCEPT { TITANIUM_LOG_DEBUG("NativeViewExample:: dtor ", this); }
