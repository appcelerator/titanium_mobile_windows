...
class NativeGlobalObjectExample final : public Titanium::GlobalObject, public JSExport<NativeGlobalObjectExample>
{
   public:
	...
	NativeGlobalObjectExample(const NativeGlobalObjectExample&,
   ...
   protected:
	...
	virtual std::shared_ptr<Timer> CreateTimer(Callback_t callback, const std::chrono::milliseconds& interval) const
	    TITANIUM_NOEXCEPT override final;
