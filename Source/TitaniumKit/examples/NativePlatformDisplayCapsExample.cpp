...
NativePlatformDisplayCapsExample::NativePlatformDisplayCapsExample(const NativePlatformDisplayCapsExample& rhs,
                                                                   const std::vector<JSValue>& arguments)
    TITANIUM_NOEXCEPT : Titanium::Platform::DisplayCaps(rhs, arguments)
{
}
