...
public:
	...
	NativeWebViewExample(const JSContext& js_context) TITANIUM_NOEXCEPT;
	NativeWebViewExample(const NativeWebViewExample&, const std::vector<JSValue>& arguments) TITANIUM_NOEXCEPT;
