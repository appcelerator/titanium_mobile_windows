...
namespace Titanium
{
	...
	{
		File::File(const JSContext& js_context) TITANIUM_NOEXCEPT : Module(js_context) {}

		File::File(const File& rhs, const std::vector<JSValue>& arguments) TITANIUM_NOEXCEPT : Module(rhs, arguments) {}
		...
		void File::JSExportInitialize()
		{
			...
			JSExport<File>::AddFunctionProperty("getRemoteBackup",
			                                    std::mem_fn(&File::getRemoteBackup_ArgumentValidator));
			JSExport<File>::AddFunctionProperty("getSize", std::mem_fn(&File::getSize_ArgumentValidator));
			JSExport<File>::AddFunctionProperty("getSymbolicLink",
			                                    std::mem_fn(&File::getSymbolicLink_ArgumentValidator));
			...
			JSExport<File>::AddFunctionProperty("createDirectory",
			                                    std::mem_fn(&File::createDirectory_ArgumentValidator));
			JSExport<File>::AddFunctionProperty("createFile", std::mem_fn(&File::createFile_ArgumentValidator));
			JSExport<File>::AddFunctionProperty("createTimestamp",
			                                    std::mem_fn(&File::createTimestamp_ArgumentValidator));
			JSExport<File>::AddFunctionProperty("deleteDirectory",
			                                    std::mem_fn(&File::deleteDirectory_ArgumentValidator));
			...
			JSExport<File>::AddFunctionProperty("getDirectoryListing",
			                                    std::mem_fn(&File::getDirectoryListing_ArgumentValidator));
			...
			JSExport<File>::AddFunctionProperty("modificationTimestamp",
			                                    std::mem_fn(&File::modificationTimestamp_ArgumentValidator));
		...
		JSValue File::get_parent_ArgumentValidator() const TITANIUM_NOEXCEPT { return get_parent(); }
		...
		JSValue File::getSize_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                        JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_size_ArgumentValidator();
		}

		JSValue File::getExecutable_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                              JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_executable_ArgumentValidator();
		}
		JSValue File::getHidden_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                          JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_hidden_ArgumentValidator();
		}
		JSValue File::getName_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                        JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_name_ArgumentValidator();
		}
		JSValue File::getNativePath_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                              JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_nativePath_ArgumentValidator();
		}
		JSValue File::getParent_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                          JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_parent_ArgumentValidator();
		}
		JSValue File::getReadonly_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                            JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_readonly_ArgumentValidator();
		}
		JSValue File::getRemoteBackup_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                                JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_remoteBackup_ArgumentValidator();
		}
		JSValue File::getSymbolicLink_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                                JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_symbolicLink_ArgumentValidator();
		}
		JSValue File::getWritable_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                            JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_writable_ArgumentValidator();
		}

		JSValue File::append_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                       JSObject& this_object) TITANIUM_NOEXCEPT
		{
			if (arguments.size() == 0) {
		...
		JSValue File::copy_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                     JSObject& this_object) TITANIUM_NOEXCEPT
		{
			if (arguments.size() == 0) {
				return get_context().CreateUndefined();
		...
		JSValue File::createDirectory_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                                JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_context().CreateBoolean(createDirectory());
		}
		JSValue File::createFile_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                           JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_context().CreateBoolean(createFile());
		}
		JSValue File::createTimestamp_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                                JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_context().CreateNumber(createTimestamp());
		}
		JSValue File::deleteDirectory_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                                JSObject& this_object) TITANIUM_NOEXCEPT
		{
		...
		JSValue File::deleteFile_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                           JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_context().CreateBoolean(deleteFile());
		}
		JSValue File::exists_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                       JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_context().CreateBoolean(exists());
		}
		JSValue File::extension_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                          JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_context().CreateString(extension());
		}
		JSValue File::getDirectoryListing_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                                    JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_context().CreateArray(getDirectoryListing());
		}
		JSValue File::isDirectory_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                            JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_context().CreateBoolean(isDirectory());
		}
		JSValue File::isFile_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                       JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_context().CreateBoolean(isFile());
		}
		JSValue File::modificationTimestamp_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                                      JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_context().CreateNumber(modificationTimestamp());
		}
		JSValue File::move_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                     JSObject& this_object) TITANIUM_NOEXCEPT
		{
			if (arguments.size() == 0) {
				return get_context().CreateUndefined();
		...
		JSValue File::open_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                     JSObject& this_object) TITANIUM_NOEXCEPT
		{
			if (arguments.size() == 0) {
				return get_context().CreateUndefined();
		...
		JSValue File::read_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                     JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return read();
		}
		JSValue File::rename_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                       JSObject& this_object) TITANIUM_NOEXCEPT
		{
			if (arguments.size() == 0) {
				return get_context().CreateUndefined();
		...
		JSValue File::resolve_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                        JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_context().CreateString(resolve());
		}
		JSValue File::spaceAvailable_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                               JSObject& this_object) TITANIUM_NOEXCEPT
		{
			return get_context().CreateNumber(spaceAvailable());
		}
		JSValue File::write_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                      JSObject& this_object) TITANIUM_NOEXCEPT
		{
			if (arguments.size() < 2) {
				return get_context().CreateUndefined();
