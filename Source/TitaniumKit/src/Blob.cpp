...
namespace Titanium
{
	Blob::Blob(const JSContext& js_context) TITANIUM_NOEXCEPT : Module(js_context) {}

	Blob::Blob(const Blob& rhs, const std::vector<JSValue>& arguments) TITANIUM_NOEXCEPT : Module(rhs, arguments) {}
	...
	void Blob::append(std::shared_ptr<Blob>&) TITANIUM_NOEXCEPT { TITANIUM_LOG_WARN("Blob::append: Unimplemented"); }
	...
	JSValue Blob::get_file_ArgumentValidator() const TITANIUM_NOEXCEPT { return get_file(); }
	...
	JSValue Blob::append_ArgumentValidator(const std::vector<JSValue>& arguments,
	...
	JSValue Blob::getFile_ArgumentValidator(const std::vector<JSValue>& arguments,
	                                        JSObject& this_object) TITANIUM_NOEXCEPT
	{
		return get_file_ArgumentValidator();
	}

	JSValue Blob::getHeight_ArgumentValidator(const std::vector<JSValue>& arguments,
	                                          JSObject& this_object) TITANIUM_NOEXCEPT
	{
		return get_height_ArgumentValidator();
	}

	JSValue Blob::getLength_ArgumentValidator(const std::vector<JSValue>& arguments,
	                                          JSObject& this_object) TITANIUM_NOEXCEPT
	{
		return get_length_ArgumentValidator();
	}

	JSValue Blob::getMimeType_ArgumentValidator(const std::vector<JSValue>& arguments,
	                                            JSObject& this_object) TITANIUM_NOEXCEPT
	{
		return get_mimeType_ArgumentValidator();
	}

	JSValue Blob::getNativePath_ArgumentValidator(const std::vector<JSValue>& arguments,
	                                              JSObject& this_object) TITANIUM_NOEXCEPT
	{
		return get_nativePath_ArgumentValidator();
	}

	JSValue Blob::getSize_ArgumentValidator(const std::vector<JSValue>& arguments,
	                                        JSObject& this_object) TITANIUM_NOEXCEPT
	{
		return get_size_ArgumentValidator();
	}

	JSValue Blob::getText_ArgumentValidator(const std::vector<JSValue>& arguments,
	                                        JSObject& this_object) TITANIUM_NOEXCEPT
	{
		return get_text_ArgumentValidator();
	}

	JSValue Blob::getWidth_ArgumentValidator(const std::vector<JSValue>& arguments,
	                                         JSObject& this_object) TITANIUM_NOEXCEPT
	{
		return get_width_ArgumentValidator();
	}

	JSValue Blob::toString_ArgumentValidator(const std::vector<JSValue>& arguments,
	                                         JSObject& this_object) TITANIUM_NOEXCEPT
	{
		return get_text_ArgumentValidator();
	}
