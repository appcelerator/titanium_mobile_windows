...
JSValue Blob::get_size_ArgumentValidator() const TITANIUM_NOEXCEPT { return get_context().CreateNumber(get_size()); }
...
JSValue Blob::get_width_ArgumentValidator() const TITANIUM_NOEXCEPT { return get_context().CreateNumber(get_width()); }
