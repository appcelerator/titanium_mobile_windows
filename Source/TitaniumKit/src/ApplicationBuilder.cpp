...
namespace Titanium
{
	...
	Application ApplicationBuilder::build()
	{
		...
		global_object__.SetProperty("Titanium", titanium,
		...
		titanium.SetProperty("Accelerometer", accelerometer__,
		                     {JSPropertyAttribute::ReadOnly, JSPropertyAttribute::DontDelete});
		...
		titanium.SetProperty("Filesystem", filesystem__,
		                     {JSPropertyAttribute::ReadOnly, JSPropertyAttribute::DontDelete});
	...
	JSObject ApplicationBuilder::TiObject() const TITANIUM_NOEXCEPT { return ti__; }
	...
	JSObject ApplicationBuilder::APIObject() const TITANIUM_NOEXCEPT { return api__; }
	...
	JSObject ApplicationBuilder::ViewObject() const TITANIUM_NOEXCEPT { return view__; }
	...
	JSObject ApplicationBuilder::WindowObject() const TITANIUM_NOEXCEPT { return window__; }
	...
	JSObject ApplicationBuilder::ButtonObject() const TITANIUM_NOEXCEPT { return button__; }
	...
	JSObject ApplicationBuilder::ImageViewObject() const TITANIUM_NOEXCEPT { return imageview__; }
	...
	JSObject ApplicationBuilder::LabelObject() const TITANIUM_NOEXCEPT { return label__; }
	...
	JSObject ApplicationBuilder::ScrollViewObject() const TITANIUM_NOEXCEPT { return scrollview__; }
	...
	JSObject ApplicationBuilder::PlatformObject() const TITANIUM_NOEXCEPT { return platform__; }
	...
	JSObject ApplicationBuilder::AccelerometerObject() const TITANIUM_NOEXCEPT { return accelerometer__; }
	...
	JSObject ApplicationBuilder::GestureObject() const TITANIUM_NOEXCEPT { return gesture__; }
	...
	JSObject ApplicationBuilder::BlobObject() const TITANIUM_NOEXCEPT { return blob__; }
	...
	JSObject ApplicationBuilder::FileObject() const TITANIUM_NOEXCEPT { return file__; }
	...
	JSObject ApplicationBuilder::FilesystemObject() const TITANIUM_NOEXCEPT { return filesystem__; }
