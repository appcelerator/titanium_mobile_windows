...
JSValue PlatformModule::get_id_ArgumentValidator() const TITANIUM_NOEXCEPT { return get_context().CreateString(id()); }
...
void PlatformModule::JSExportInitialize()
{
	...
	JSExport<PlatformModule>::AddFunctionProperty("getAvailableMemory",
	                                              std::mem_fn(&PlatformModule::getAvailableMemoryArgumentValidator));
	JSExport<PlatformModule>::AddFunctionProperty("getBatteryLevel",
	                                              std::mem_fn(&PlatformModule::getBatteryLevelArgumentValidator));
	JSExport<PlatformModule>::AddFunctionProperty("getBatteryMonitoring",
	                                              std::mem_fn(&PlatformModule::getBatteryMonitoringArgumentValidator));
	...
	JSExport<PlatformModule>::AddFunctionProperty("is24HourTimeFormat",
	                                              std::mem_fn(&PlatformModule::is24HourTimeFormatArgumentValidator));
