...
namespace Titanium
{
	namespace Platform
	{
		DisplayCaps::DisplayCaps(const JSContext& js_context) TITANIUM_NOEXCEPT : Module(js_context) {}
		...
		void DisplayCaps::JSExportInitialize()
		{
			...
			JSExport<DisplayCaps>::AddValueProperty("density",
			                                        std::mem_fn(&DisplayCaps::get_density_ArgumentValidator));
			JSExport<DisplayCaps>::AddFunctionProperty("getDensity",
			                                           std::mem_fn(&DisplayCaps::getDensityArgumentValidator));
			...
			JSExport<DisplayCaps>::AddValueProperty(
			    "logicalDensityFactor", std::mem_fn(&DisplayCaps::get_logicalDensityFactor_ArgumentValidator));
			JSExport<DisplayCaps>::AddFunctionProperty(
			    "getLogicalDensityFactor", std::mem_fn(&DisplayCaps::getLogicalDensityFactorArgumentValidator));
			JSExport<DisplayCaps>::AddValueProperty("platformHeight",
			                                        std::mem_fn(&DisplayCaps::get_platformHeight_ArgumentValidator));
			JSExport<DisplayCaps>::AddFunctionProperty("getPlatformHeight",
			                                           std::mem_fn(&DisplayCaps::getPlatformHeightArgumentValidator));
			JSExport<DisplayCaps>::AddValueProperty("platformWidth",
			                                        std::mem_fn(&DisplayCaps::get_platformWidth_ArgumentValidator));
			JSExport<DisplayCaps>::AddFunctionProperty("getPlatformWidth",
			                                           std::mem_fn(&DisplayCaps::getPlatformWidthArgumentValidator));
		...
		std::string DisplayCaps::density() const TITANIUM_NOEXCEPT { return ""; }
		double DisplayCaps::dpi() const TITANIUM_NOEXCEPT { return 0; }
		double DisplayCaps::logicalDensityFactor() const TITANIUM_NOEXCEPT { return 0; }
		double DisplayCaps::platformHeight() const TITANIUM_NOEXCEPT { return 0; }
		double DisplayCaps::platformWidth() const TITANIUM_NOEXCEPT { return 0; }
		double DisplayCaps::xdpi() const TITANIUM_NOEXCEPT { return 0; }
		double DisplayCaps::ydpi() const TITANIUM_NOEXCEPT { return 0; }
		...
		JSValue DisplayCaps::getLogicalDensityFactorArgumentValidator(const std::vector<JSValue>&,
		...
		JSValue DisplayCaps::getPlatformHeightArgumentValidator(const std::vector<JSValue>&,
		                                                        JSObject&) const TITANIUM_NOEXCEPT
		{
		...
		JSValue DisplayCaps::getPlatformWidthArgumentValidator(const std::vector<JSValue>&,
		                                                       JSObject&) const TITANIUM_NOEXCEPT
		{
