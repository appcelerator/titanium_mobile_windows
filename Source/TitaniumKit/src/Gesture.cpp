...
namespace Titanium
{
Gesture::Gesture(const JSContext& js_context) TITANIUM_NOEXCEPT : Module(js_context) {}

Gesture::Gesture(const Gesture& rhs, const std::vector<JSValue>& arguments) TITANIUM_NOEXCEPT : Module(rhs, arguments)
{
}
...
JSValue Gesture::getOrientation_ArgumentValidator(const std::vector<JSValue>& arguments,
                                                  JSObject& this_object) TITANIUM_NOEXCEPT
{
	return get_orientation_ArgumentValidator();
}

JSValue Gesture::isFaceDown_ArgumentValidator(const std::vector<JSValue>& arguments,
                                              JSObject& this_object) TITANIUM_NOEXCEPT
{
	return get_context().CreateBoolean(get_orientation() == UI::ORIENTATION::FACE_DOWN);
}

JSValue Gesture::isFaceUp_ArgumentValidator(const std::vector<JSValue>& arguments,
                                            JSObject& this_object) TITANIUM_NOEXCEPT
{
	return get_context().CreateBoolean(get_orientation() == UI::ORIENTATION::FACE_UP);
}

JSValue Gesture::isLandscape_ArgumentValidator(const std::vector<JSValue>& arguments,
                                               JSObject& this_object) TITANIUM_NOEXCEPT
{
	return get_landscape_ArgumentValidator();
}

JSValue Gesture::isPortrait_ArgumentValidator(const std::vector<JSValue>& arguments,
                                              JSObject& this_object) TITANIUM_NOEXCEPT
{
	return get_portrait_ArgumentValidator();
}

JSValue Gesture::getLandscape_ArgumentValidator(const std::vector<JSValue>& arguments,
                                                JSObject& this_object) TITANIUM_NOEXCEPT
{
	return get_landscape_ArgumentValidator();
}
...
JSValue Gesture::getPortrait_ArgumentValidator(const std::vector<JSValue>& arguments,
                                               JSObject& this_object) TITANIUM_NOEXCEPT
{
	return get_portrait_ArgumentValidator();
}
