...
namespace Titanium
{
	...
	FilesystemModule::FilesystemModule(const FilesystemModule& rhs,
	                                   const std::vector<JSValue>& arguments) TITANIUM_NOEXCEPT
	...
	void FilesystemModule::JSExportInitialize()
	{
		...
		JSExport<FilesystemModule>::AddFunctionProperty(
		    "createTempFile", std::mem_fn(&FilesystemModule::createTempFile_ArgumentValidator));
		JSExport<FilesystemModule>::AddFunctionProperty(
		...
		JSExport<FilesystemModule>::AddValueProperty(
		    ...
		    std::mem_fn(&FilesystemModule::applicationSupportDirectory_ArgumentValidator));
		JSExport<FilesystemModule>::AddValueProperty(
		    "externalStorageDirectory", std::mem_fn(&FilesystemModule::externalStorageDirectory_ArgumentValidator));
		JSExport<FilesystemModule>::AddValueProperty(
		    "resourcesDirectory", std::mem_fn(&FilesystemModule::resourcesDirectory_ArgumentValidator));
		...
		JSExport<FilesystemModule>::AddFunctionProperty(
		    "getLineEnding", std::mem_fn(&FilesystemModule::getLineEnding_ArgumentValidator));
		JSExport<FilesystemModule>::AddFunctionProperty(
		    "getApplicationCacheDirectory",
		    std::mem_fn(&FilesystemModule::getApplicationCacheDirectory_ArgumentValidator));
		JSExport<FilesystemModule>::AddFunctionProperty(
		    "getApplicationDataDirectory",
		    std::mem_fn(&FilesystemModule::getApplicationDataDirectory_ArgumentValidator));
		JSExport<FilesystemModule>::AddFunctionProperty(
		...
		JSExport<FilesystemModule>::AddFunctionProperty(
		    ...
		    std::mem_fn(&FilesystemModule::getExternalStorageDirectory_ArgumentValidator));
		JSExport<FilesystemModule>::AddFunctionProperty(
		    "getResourcesDirectory", std::mem_fn(&FilesystemModule::getResourcesDirectory_ArgumentValidator));
		JSExport<FilesystemModule>::AddFunctionProperty(
		    "getTempDirectory", std::mem_fn(&FilesystemModule::getTempDirectory_ArgumentValidator));
	}
	...
	JSValue FilesystemModule::getSeparator_ArgumentValidator(const std::vector<JSValue>&,
