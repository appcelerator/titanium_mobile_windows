...
FilesystemModule::FilesystemModule(const JSContext& js_context) TITANIUM_NOEXCEPT
    : Module(js_context),
      mode_read__(js_context.CreateNumber(
          Titanium::Filesystem::Constants::to_underlying_type(Titanium::Filesystem::MODE::READ))),
      mode_write__(js_context.CreateNumber(
          Titanium::Filesystem::Constants::to_underlying_type(Titanium::Filesystem::MODE::WRITE))),
      mode_append__(js_context.CreateNumber(
          Titanium::Filesystem::Constants::to_underlying_type(Titanium::Filesystem::MODE::APPEND)))
{
}
...
JSValue FilesystemModule::MODE_READ() const TITANIUM_NOEXCEPT { return mode_read__; }
JSValue FilesystemModule::MODE_WRITE() const TITANIUM_NOEXCEPT { return mode_write__; }
JSValue FilesystemModule::MODE_APPEND() const TITANIUM_NOEXCEPT { return mode_append__; }

std::string FilesystemModule::separator() const TITANIUM_NOEXCEPT { return "/"; }
...
JSValue FilesystemModule::openStream(std::unordered_set<Titanium::Filesystem::MODE> modes,
                                     const std::string& path) TITANIUM_NOEXCEPT
{
...
std::string FilesystemModule::lineEnding() const TITANIUM_NOEXCEPT { return "\n"; }
...
void FilesystemModule::JSExportInitialize()
{
	...
	JSExport<FilesystemModule>::AddFunctionProperty("getFile",
	                                                std::mem_fn(&FilesystemModule::getFile_ArgumentValidator));
	JSExport<FilesystemModule>::AddFunctionProperty(
	    "createTempDirectory", std::mem_fn(&FilesystemModule::createTempDirectory_ArgumentValidator));
	JSExport<FilesystemModule>::AddFunctionProperty("createTempFile",
	                                                std::mem_fn(&FilesystemModule::createTempFile_ArgumentValidator));
	JSExport<FilesystemModule>::AddFunctionProperty(
	    "isExternalStoragePresent", std::mem_fn(&FilesystemModule::isExternalStoragePresent_ArgumentValidator));
	JSExport<FilesystemModule>::AddFunctionProperty("openStream",
	                                                std::mem_fn(&FilesystemModule::openStream_ArgumentValidator));
	...
	JSExport<FilesystemModule>::AddValueProperty("separator",
	                                             std::mem_fn(&FilesystemModule::separator_ArgumentValidator));
	JSExport<FilesystemModule>::AddValueProperty("lineEnding",
	                                             std::mem_fn(&FilesystemModule::lineEnding_ArgumentValidator));
	JSExport<FilesystemModule>::AddValueProperty(
	    "applicationCacheDirectory", std::mem_fn(&FilesystemModule::applicationCacheDirectory_ArgumentValidator));
	JSExport<FilesystemModule>::AddValueProperty(
	    "applicationDataDirectory", std::mem_fn(&FilesystemModule::applicationDataDirectory_ArgumentValidator));
	JSExport<FilesystemModule>::AddValueProperty(
	    "applicationDirectory", std::mem_fn(&FilesystemModule::applicationDirectory_ArgumentValidator));
	JSExport<FilesystemModule>::AddValueProperty(
	    "applicationSupportDirectory", std::mem_fn(&FilesystemModule::applicationSupportDirectory_ArgumentValidator));
	JSExport<FilesystemModule>::AddValueProperty(
	    "externalStorageDirectory", std::mem_fn(&FilesystemModule::externalStorageDirectory_ArgumentValidator));
	JSExport<FilesystemModule>::AddValueProperty("resourcesDirectory",
	                                             std::mem_fn(&FilesystemModule::resourcesDirectory_ArgumentValidator));
	JSExport<FilesystemModule>::AddValueProperty("tempDirectory",
	                                             std::mem_fn(&FilesystemModule::tempDirectory_ArgumentValidator));
	JSExport<FilesystemModule>::AddFunctionProperty("getSeparator",
	                                                std::mem_fn(&FilesystemModule::getSeparator_ArgumentValidator));
	JSExport<FilesystemModule>::AddFunctionProperty("getLineEnding",
	                                                std::mem_fn(&FilesystemModule::getLineEnding_ArgumentValidator));
	JSExport<FilesystemModule>::AddFunctionProperty(
	    "getApplicationCacheDirectory", std::mem_fn(&FilesystemModule::getApplicationCacheDirectory_ArgumentValidator));
	JSExport<FilesystemModule>::AddFunctionProperty(
	    "getApplicationDataDirectory", std::mem_fn(&FilesystemModule::getApplicationDataDirectory_ArgumentValidator));
	JSExport<FilesystemModule>::AddFunctionProperty(
	    "getApplicationDirectory", std::mem_fn(&FilesystemModule::getApplicationDirectory_ArgumentValidator));
	JSExport<FilesystemModule>::AddFunctionProperty(
	    "getApplicationSupportDirectory",
	    std::mem_fn(&FilesystemModule::getApplicationSupportDirectory_ArgumentValidator));
	JSExport<FilesystemModule>::AddFunctionProperty(
	    "getExternalStorageDirectory", std::mem_fn(&FilesystemModule::getExternalStorageDirectory_ArgumentValidator));
	JSExport<FilesystemModule>::AddFunctionProperty(
	    "getResourcesDirectory", std::mem_fn(&FilesystemModule::getResourcesDirectory_ArgumentValidator));
	JSExport<FilesystemModule>::AddFunctionProperty("getTempDirectory",
	                                                std::mem_fn(&FilesystemModule::getTempDirectory_ArgumentValidator));
}

JSValue FilesystemModule::getFile_ArgumentValidator(const std::vector<JSValue>& arguments,
...
JSValue FilesystemModule::createTempDirectory_ArgumentValidator(const std::vector<JSValue>&,
                                                                JSObject&) TITANIUM_NOEXCEPT
{
...
JSValue FilesystemModule::isExternalStoragePresent_ArgumentValidator(const std::vector<JSValue>&,
                                                                     JSObject&) TITANIUM_NOEXCEPT
{
	return get_context().CreateBoolean(isExternalStoragePresent());
}
JSValue FilesystemModule::openStream_ArgumentValidator(const std::vector<JSValue>& arguments,
                                                       JSObject&) TITANIUM_NOEXCEPT
{
	if (arguments.size() < 2) {
	...
	const auto modes = Titanium::Filesystem::Constants::to_MODE(
	    static_cast<std::underlying_type<Titanium::Filesystem::MODE>::type>(_0));
...
JSValue FilesystemModule::getApplicationCacheDirectory_ArgumentValidator(const std::vector<JSValue>&,
                                                                         JSObject&) const TITANIUM_NOEXCEPT
{
	return applicationCacheDirectory_ArgumentValidator();
}
JSValue FilesystemModule::getApplicationDataDirectory_ArgumentValidator(const std::vector<JSValue>&,
                                                                        JSObject&) const TITANIUM_NOEXCEPT
{
	return applicationDataDirectory_ArgumentValidator();
}
JSValue FilesystemModule::getApplicationDirectory_ArgumentValidator(const std::vector<JSValue>&,
                                                                    JSObject&) const TITANIUM_NOEXCEPT
{
	return applicationDirectory_ArgumentValidator();
}
JSValue FilesystemModule::getApplicationSupportDirectory_ArgumentValidator(const std::vector<JSValue>&,
                                                                           JSObject&) const TITANIUM_NOEXCEPT
{
	return applicationSupportDirectory_ArgumentValidator();
}
JSValue FilesystemModule::getExternalStorageDirectory_ArgumentValidator(const std::vector<JSValue>&,
                                                                        JSObject&) const TITANIUM_NOEXCEPT
{
	return externalStorageDirectory_ArgumentValidator();
}
JSValue FilesystemModule::getLineEnding_ArgumentValidator(const std::vector<JSValue>&,
                                                          JSObject&) const TITANIUM_NOEXCEPT
{
	return lineEnding_ArgumentValidator();
}
JSValue FilesystemModule::getResourcesDirectory_ArgumentValidator(const std::vector<JSValue>&,
                                                                  JSObject&) const TITANIUM_NOEXCEPT
{
	return resourcesDirectory_ArgumentValidator();
}
JSValue FilesystemModule::getTempDirectory_ArgumentValidator(const std::vector<JSValue>&,
                                                             JSObject&) const TITANIUM_NOEXCEPT
{
