...
namespace Titanium
{
	namespace UI
	{
		...
		INPUT_BORDERSTYLE TextField::get_borderStyle() const TITANIUM_NOEXCEPT { return borderStyle__; }
		...
		INPUT_BUTTONMODE TextField::get_clearButtonMode() const TITANIUM_NOEXCEPT { return clearButtonMode__; }
		...
		INPUT_BUTTONMODE TextField::get_leftButtonMode() const TITANIUM_NOEXCEPT { return leftButtonMode__; }
		...
		INPUT_BUTTONMODE TextField::get_rightButtonMode() const TITANIUM_NOEXCEPT { return rightButtonMode__; }
		...
		KEYBOARD TextField::get_keyboardType() const TITANIUM_NOEXCEPT { return keyboardType__; }
		...
		RETURNKEY TextField::get_returnKeyType() const TITANIUM_NOEXCEPT { return returnKeyType__; }
		...
		TEXT_ALIGNMENT TextField::get_textAlign() const TITANIUM_NOEXCEPT { return textAlign__; }
		...
		TEXT_VERTICAL_ALIGNMENT TextField::get_verticalAlign() const TITANIUM_NOEXCEPT { return verticalAlign__; }
		...
		void TextField::JSExportInitialize()
		{
			...
			JSExport<TextField>::AddValueProperty("curve", std::mem_fn(&TextField::getBorderStyleArgumentValidator),
			                                      std::mem_fn(&TextField::setBorderStyleArgumentValidator));
			JSExport<TextField>::AddValueProperty("clearButtonMode",
			                                      std::mem_fn(&TextField::getClearButtonModeArgumentValidator),
			                                      std::mem_fn(&TextField::setClearButtonModeArgumentValidator));
			JSExport<TextField>::AddValueProperty("leftButtonMode",
			                                      std::mem_fn(&TextField::getLeftButtonModeArgumentValidator),
			                                      std::mem_fn(&TextField::setLeftButtonModeArgumentValidator));
			JSExport<TextField>::AddValueProperty("rightButtonMode",
			                                      std::mem_fn(&TextField::getRightButtonModeArgumentValidator),
			                                      std::mem_fn(&TextField::setRightButtonModeArgumentValidator));
			JSExport<TextField>::AddValueProperty("keyboardType",
			                                      std::mem_fn(&TextField::getKeyboardTypeArgumentValidator),
			                                      std::mem_fn(&TextField::setKeyboardTypeArgumentValidator));
			JSExport<TextField>::AddValueProperty("returnKeyType",
			                                      std::mem_fn(&TextField::getReturnKeyTypeArgumentValidator),
			                                      std::mem_fn(&TextField::setReturnKeyTypeArgumentValidator));
			JSExport<TextField>::AddValueProperty("textAlign", std::mem_fn(&TextField::getTextAlignArgumentValidator),
			                                      std::mem_fn(&TextField::setTextAlignArgumentValidator));
			JSExport<TextField>::AddValueProperty("autocapitalization",
			                                      std::mem_fn(&TextField::getAutoCapitalizationArgumentValidator),
			                                      std::mem_fn(&TextField::setAutoCapitalizationArgumentValidator));
			JSExport<TextField>::AddValueProperty("verticalAlign",
			                                      std::mem_fn(&TextField::getVerticalAlignArgumentValidator),
			                                      std::mem_fn(&TextField::setVerticalAlignArgumentValidator));
		}

		JSValue TextField::getBorderStyleArgumentValidator() const TITANIUM_NOEXCEPT
		{
			return get_context().CreateNumber(
			    static_cast<std::underlying_type<INPUT_BORDERSTYLE>::type>(get_borderStyle()));
		}
		...
		bool TextField::setBorderStyleArgumentValidator(const JSValue& argument) TITANIUM_NOEXCEPT
		{
			...
			borderStyle__ =
			    Constants::to_INPUT_BORDERSTYLE(static_cast<std::underlying_type<INPUT_BORDERSTYLE>::type>(argument));
		...
		{
			return get_context().CreateNumber(
			    static_cast<std::underlying_type<INPUT_BUTTONMODE>::type>(get_clearButtonMode()));
		}
		...
		bool TextField::setClearButtonModeArgumentValidator(const JSValue& argument) TITANIUM_NOEXCEPT
		{
			TITANIUM_ASSERT(argument.IsNumber());
			clearButtonMode__ =
			    Constants::to_INPUT_BUTTONMODE(static_cast<std::underlying_type<INPUT_BUTTONMODE>::type>(argument));
		...
		{
			return get_context().CreateNumber(
			    static_cast<std::underlying_type<INPUT_BUTTONMODE>::type>(get_leftButtonMode()));
		}
		...
		{
			return get_context().CreateNumber(
			    static_cast<std::underlying_type<INPUT_BUTTONMODE>::type>(get_rightButtonMode()));
		}
		...
		bool TextField::setRightButtonModeArgumentValidator(const JSValue& argument) TITANIUM_NOEXCEPT
		{
			TITANIUM_ASSERT(argument.IsNumber());
			rightButtonMode__ =
			    Constants::to_INPUT_BUTTONMODE(static_cast<std::underlying_type<KEYBOARD>::type>(argument));
		...
		bool TextField::setTextAlignArgumentValidator(const JSValue& argument) TITANIUM_NOEXCEPT
		{
			...
			if (argument.IsNumber()) {
				textAlign__ =
				    Constants::to_TEXT_ALIGNMENT(static_cast<std::underlying_type<TEXT_ALIGNMENT>::type>(argument));
		...
		{
			return get_context().CreateNumber(
			    static_cast<std::underlying_type<TEXT_AUTOCAPITALIZATION>::type>(get_autoCapitalization()));
		}

		bool TextField::setAutoCapitalizationArgumentValidator(const JSValue& argument) TITANIUM_NOEXCEPT
		{
			TITANIUM_ASSERT(argument.IsNumber());
			autoCapitalization__ = Constants::to_TEXT_AUTOCAPITALIZATION(
			    static_cast<std::underlying_type<TEXT_AUTOCAPITALIZATION>::type>(argument));
		...
		{
			return get_context().CreateNumber(
			    static_cast<std::underlying_type<TEXT_VERTICAL_ALIGNMENT>::type>(get_verticalAlign()));
		}
		...
		bool TextField::setVerticalAlignArgumentValidator(const JSValue& argument) TITANIUM_NOEXCEPT
		{
			bool result = false;
			if (argument.IsNumber()) {
				verticalAlign__ = Constants::to_TEXT_VERTICAL_ALIGNMENT(
				    static_cast<std::underlying_type<TEXT_VERTICAL_ALIGNMENT>::type>(argument));
