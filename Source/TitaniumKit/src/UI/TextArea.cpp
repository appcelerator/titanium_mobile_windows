...
namespace Titanium
{
	namespace UI
	{
		...
		std::unordered_set<AUTOLINK> TextArea::get_autoLink() const TITANIUM_NOEXCEPT { return autoLink__; }
		...
		KEYBOARD TextArea::get_keyboardType() const TITANIUM_NOEXCEPT { return keyboardType__; }
		...
		RETURNKEY TextArea::get_returnKeyType() const TITANIUM_NOEXCEPT { return returnKeyType__; }
		...
		TEXT_ALIGNMENT TextArea::get_textAlign() const TITANIUM_NOEXCEPT { return textAlign__; }
		...
		TEXT_VERTICAL_ALIGNMENT TextArea::get_verticalAlign() const TITANIUM_NOEXCEPT { return verticalAlign__; }
		...
		void TextArea::JSExportInitialize()
		{
			...
			JSExport<TextArea>::AddValueProperty("curve", std::mem_fn(&TextArea::getAutoLinkArgumentValidator),
			                                     std::mem_fn(&TextArea::setAutoLinkArgumentValidator));
			JSExport<TextArea>::AddValueProperty("keyboardType",
			                                     std::mem_fn(&TextArea::getKeyboardTypeArgumentValidator),
			                                     std::mem_fn(&TextArea::setKeyboardTypeArgumentValidator));
			JSExport<TextArea>::AddValueProperty("returnKeyType",
			                                     std::mem_fn(&TextArea::getReturnKeyTypeArgumentValidator),
			                                     std::mem_fn(&TextArea::setReturnKeyTypeArgumentValidator));
			JSExport<TextArea>::AddValueProperty("textAlign", std::mem_fn(&TextArea::getTextAlignArgumentValidator),
			                                     std::mem_fn(&TextArea::setTextAlignArgumentValidator));
			JSExport<TextArea>::AddValueProperty("autocapitalization",
			                                     std::mem_fn(&TextArea::getAutoCapitalizationArgumentValidator),
			                                     std::mem_fn(&TextArea::setAutoCapitalizationArgumentValidator));
			JSExport<TextArea>::AddValueProperty("verticalAlign",
			                                     std::mem_fn(&TextArea::getVerticalAlignArgumentValidator),
			                                     std::mem_fn(&TextArea::setVerticalAlignArgumentValidator));
		}
