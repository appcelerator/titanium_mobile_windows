	...
	namespace UI
	{
		...
		ANIMATION_CURVE Constants::to_ANIMATION_CURVE(const std::string& animationCurveName) TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_ANIMATION_CURVE: Titanium::UI::ANIMATION_CURVE with name '",
				                  animationCurveName, "' does not exist");
			}

			return animationCurve;
		}

		ANIMATION_CURVE Constants::to_ANIMATION_CURVE(
		    std::underlying_type<ANIMATION_CURVE>::type animationCurve_underlying_type) TITANIUM_NOEXCEPT
		{
			static std::unordered_map<std::underlying_type<ANIMATION_CURVE>::type, ANIMATION_CURVE> map;
			static std::once_flag of;
			std::call_once(of, []() {
				map[static_cast<std::underlying_type<ANIMATION_CURVE>::type>(ANIMATION_CURVE::EASE_IN)] =
				    ANIMATION_CURVE::EASE_IN;
				map[static_cast<std::underlying_type<ANIMATION_CURVE>::type>(ANIMATION_CURVE::EASE_IN_OUT)] =
				    ANIMATION_CURVE::EASE_IN_OUT;
				map[static_cast<std::underlying_type<ANIMATION_CURVE>::type>(ANIMATION_CURVE::EASE_OUT)] =
				    ANIMATION_CURVE::EASE_OUT;
				map[static_cast<std::underlying_type<ANIMATION_CURVE>::type>(ANIMATION_CURVE::LINEAR)] =
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_ANIMATION_CURVE: Titanium::UI::ANIMATION_CURVE with value '",
				                  animationCurve_underlying_type, "' does not exist");
			}

			return animationCurve;
		}

		std::underlying_type<ANIMATION_CURVE>::type Constants::to_underlying_type(const ANIMATION_CURVE& animationCurve)
		    TITANIUM_NOEXCEPT
		{
		...
		AUTOLINK Constants::to_AUTOLINK(const std::string& autoLinkName) TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_AUTOLINK: Titanium::UI::AUTOLINK with name '", autoLinkName,
				                  "' does not exist");
			}
		...
		std::unordered_set<AUTOLINK> Constants::to_AUTOLINK(std::underlying_type<AUTOLINK>::type autoLinks)
		    TITANIUM_NOEXCEPT
		{
		...
		std::underlying_type<AUTOLINK>::type Constants::to_underlying_type(
		    const std::unordered_set<AUTOLINK>& autoLink_set) TITANIUM_NOEXCEPT
		{
		...
		EXTEND_EDGE Constants::to_EXTEND_EDGE(const std::string& extendEdgeName) TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_EXTEND_EDGE: Titanium::UI::EXTEND_EDGE with name '", extendEdgeName,
				                  "' does not exist");
			}
		...
		std::unordered_set<EXTEND_EDGE> Constants::to_EXTEND_EDGE(std::underlying_type<EXTEND_EDGE>::type extendEdges)
		    TITANIUM_NOEXCEPT
		{
		...
		std::underlying_type<EXTEND_EDGE>::type Constants::to_underlying_type(
		    const std::unordered_set<EXTEND_EDGE>& extendEdge_set) TITANIUM_NOEXCEPT
		{
		...
		std::underlying_type<EXTEND_EDGE>::type Constants::to_underlying_type(const EXTEND_EDGE& extendEdge)
		    TITANIUM_NOEXCEPT
		{
		...
		ORIENTATION Constants::to_ORIENTATION(const std::string& orientationName) TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_ORIENTATION: Titanium::UI::ORIENTATION with name '", orientationName,
				                  "' does not exist");
			}
		...
		ORIENTATION Constants::to_ORIENTATION(std::underlying_type<ORIENTATION>::type orientation_underlying_type)
		    TITANIUM_NOEXCEPT
		{
			static std::unordered_map<std::underlying_type<ORIENTATION>::type, ORIENTATION> map;
			static std::once_flag of;
			std::call_once(of, []() {
				map[static_cast<std::underlying_type<ORIENTATION>::type>(ORIENTATION::PORTRAIT)] =
				    ORIENTATION::PORTRAIT;
				map[static_cast<std::underlying_type<ORIENTATION>::type>(ORIENTATION::UPSIDE_PORTRAIT)] =
				    ORIENTATION::UPSIDE_PORTRAIT;
				map[static_cast<std::underlying_type<ORIENTATION>::type>(ORIENTATION::LANDSCAPE_LEFT)] =
				    ORIENTATION::LANDSCAPE_LEFT;
				map[static_cast<std::underlying_type<ORIENTATION>::type>(ORIENTATION::LANDSCAPE_RIGHT)] =
				    ORIENTATION::LANDSCAPE_RIGHT;
				map[static_cast<std::underlying_type<ORIENTATION>::type>(ORIENTATION::FACE_UP)] = ORIENTATION::FACE_UP;
				map[static_cast<std::underlying_type<ORIENTATION>::type>(ORIENTATION::FACE_DOWN)] =
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_ORIENTATION: Titanium::UI::ORIENTATION with value '",
				                  orientation_underlying_type, "' does not exist");
			}

			return orientation;
		}

		std::underlying_type<ORIENTATION>::type Constants::to_underlying_type(const ORIENTATION& orientation)
		    TITANIUM_NOEXCEPT
		{
		...
		INPUT_BORDERSTYLE Constants::to_INPUT_BORDERSTYLE(const std::string& inputBorderStyleName) TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_INPUT_BORDERSTYLE: Titanium::UI::INPUT_BORDERSTYLE with name '",
				                  inputBorderStyleName, "' does not exist");
			}

			return inputBorderStyle;
		}

		INPUT_BORDERSTYLE Constants::to_INPUT_BORDERSTYLE(
		    std::underlying_type<INPUT_BORDERSTYLE>::type inputBorderStyle_underlying_type) TITANIUM_NOEXCEPT
		{
			static std::unordered_map<std::underlying_type<INPUT_BORDERSTYLE>::type, INPUT_BORDERSTYLE> map;
			static std::once_flag of;
			std::call_once(of, []() {
				map[static_cast<std::underlying_type<INPUT_BORDERSTYLE>::type>(INPUT_BORDERSTYLE::BEZEL)] =
				    INPUT_BORDERSTYLE::BEZEL;
				map[static_cast<std::underlying_type<INPUT_BORDERSTYLE>::type>(INPUT_BORDERSTYLE::LINE)] =
				    INPUT_BORDERSTYLE::LINE;
				map[static_cast<std::underlying_type<INPUT_BORDERSTYLE>::type>(INPUT_BORDERSTYLE::NONE)] =
				    INPUT_BORDERSTYLE::NONE;
				map[static_cast<std::underlying_type<INPUT_BORDERSTYLE>::type>(INPUT_BORDERSTYLE::ROUNDED)] =
				    INPUT_BORDERSTYLE::ROUNDED;
			});
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_INPUT_BORDERSTYLE: Titanium::UI::INPUT_BORDERSTYLE with value '",
				                  inputBorderStyle_underlying_type, "' does not exist");
			}

			return inputBorderStyle;
		}

		std::underlying_type<INPUT_BORDERSTYLE>::type Constants::to_underlying_type(
		    const INPUT_BORDERSTYLE& inputBorderStyle) TITANIUM_NOEXCEPT
		{
		...
		INPUT_BUTTONMODE Constants::to_INPUT_BUTTONMODE(const std::string& inputButtonModeName) TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_INPUT_BUTTONMODE: Titanium::UI::INPUT_BUTTONMODE with name '",
				                  inputButtonModeName, "' does not exist");
			}

			return inputButtonMode;
		}

		INPUT_BUTTONMODE Constants::to_INPUT_BUTTONMODE(
		    std::underlying_type<INPUT_BUTTONMODE>::type inputButtonMode_underlying_type) TITANIUM_NOEXCEPT
		{
			static std::unordered_map<std::underlying_type<INPUT_BUTTONMODE>::type, INPUT_BUTTONMODE> map;
			static std::once_flag of;
			std::call_once(of, []() {
				map[static_cast<std::underlying_type<INPUT_BUTTONMODE>::type>(INPUT_BUTTONMODE::ALWAYS)] =
				    INPUT_BUTTONMODE::ALWAYS;
				map[static_cast<std::underlying_type<INPUT_BUTTONMODE>::type>(INPUT_BUTTONMODE::NEVER)] =
				    INPUT_BUTTONMODE::NEVER;
				map[static_cast<std::underlying_type<INPUT_BUTTONMODE>::type>(INPUT_BUTTONMODE::ONBLUR)] =
				    INPUT_BUTTONMODE::ONBLUR;
				map[static_cast<std::underlying_type<INPUT_BUTTONMODE>::type>(INPUT_BUTTONMODE::ONFOCUS)] =
				    INPUT_BUTTONMODE::ONFOCUS;
			});
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_INPUT_BUTTONMODE: Titanium::UI::INPUT_BUTTONMODE with value '",
				                  inputButtonMode_underlying_type, "' does not exist");
			}

			return inputButtonMode;
		}

		std::underlying_type<INPUT_BUTTONMODE>::type Constants::to_underlying_type(
		    const INPUT_BUTTONMODE& inputButtonMode) TITANIUM_NOEXCEPT
		{
		...
		KEYBOARD_APPEARANCE Constants::to_KEYBOARD_APPEARANCE(const std::string& keyboardAppearanceName)
		    TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_KEYBOARD_APPEARANCE: Titanium::UI::KEYBOARD_APPEARANCE with name '",
				                  keyboardAppearanceName, "' does not exist");
			}

			return keyboardAppearance;
		}

		KEYBOARD_APPEARANCE Constants::to_KEYBOARD_APPEARANCE(
		    std::underlying_type<KEYBOARD_APPEARANCE>::type keyboardAppearance_underlying_type) TITANIUM_NOEXCEPT
		{
			static std::unordered_map<std::underlying_type<KEYBOARD_APPEARANCE>::type, KEYBOARD_APPEARANCE> map;
			static std::once_flag of;
			std::call_once(of, []() {
				map[static_cast<std::underlying_type<KEYBOARD_APPEARANCE>::type>(KEYBOARD_APPEARANCE::ALERT)] =
				    KEYBOARD_APPEARANCE::ALERT;
				map[static_cast<std::underlying_type<KEYBOARD_APPEARANCE>::type>(KEYBOARD_APPEARANCE::DEFAULT)] =
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_KEYBOARD_APPEARANCE: Titanium::UI::KEYBOARD_APPEARANCE with value '",
				                  keyboardAppearance_underlying_type, "' does not exist");
			}

			return keyboardAppearance;
		}

		std::underlying_type<KEYBOARD_APPEARANCE>::type Constants::to_underlying_type(
		    const KEYBOARD_APPEARANCE& keyboardAppearance) TITANIUM_NOEXCEPT
		{
		...
		KEYBOARD Constants::to_KEYBOARD(const std::string& keyboardName) TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_KEYBOARD: Titanium::UI::KEYBOARD with name '", keyboardName,
				                  "' does not exist");
			}
		...
		KEYBOARD Constants::to_KEYBOARD(std::underlying_type<KEYBOARD>::type keyboard_underlying_type) TITANIUM_NOEXCEPT
		{
			...
			std::call_once(of, []() {
				...
				map[static_cast<std::underlying_type<KEYBOARD>::type>(KEYBOARD::NAMEPHONE_PAD)] =
				    KEYBOARD::NAMEPHONE_PAD;
				map[static_cast<std::underlying_type<KEYBOARD>::type>(KEYBOARD::NUMBERS_PUNCTUATION)] =
				    KEYBOARD::NUMBERS_PUNCTUATION;
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_KEYBOARD: Titanium::UI::KEYBOARD with value '",
				                  keyboard_underlying_type, "' does not exist");
			}
		...
		LIST_ACCESSORY_TYPE Constants::to_LIST_ACCESSORY_TYPE(const std::string& listAccessoryTypeName)
		    TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_LIST_ACCESSORY_TYPE: Titanium::UI::LIST_ACCESSORY_TYPE with name '",
				                  listAccessoryTypeName, "' does not exist");
			}

			return listAccessoryType;
		}

		LIST_ACCESSORY_TYPE Constants::to_LIST_ACCESSORY_TYPE(
		    std::underlying_type<LIST_ACCESSORY_TYPE>::type listAccessoryType_underlying_type) TITANIUM_NOEXCEPT
		{
			static std::unordered_map<std::underlying_type<LIST_ACCESSORY_TYPE>::type, LIST_ACCESSORY_TYPE> map;
			static std::once_flag of;
			std::call_once(of, []() {
				map[static_cast<std::underlying_type<LIST_ACCESSORY_TYPE>::type>(LIST_ACCESSORY_TYPE::CHECKMARK)] =
				    LIST_ACCESSORY_TYPE::CHECKMARK;
				map[static_cast<std::underlying_type<LIST_ACCESSORY_TYPE>::type>(LIST_ACCESSORY_TYPE::DETAIL)] =
				    LIST_ACCESSORY_TYPE::DETAIL;
				map[static_cast<std::underlying_type<LIST_ACCESSORY_TYPE>::type>(LIST_ACCESSORY_TYPE::DISCLOSURE)] =
				    LIST_ACCESSORY_TYPE::DISCLOSURE;
				map[static_cast<std::underlying_type<LIST_ACCESSORY_TYPE>::type>(LIST_ACCESSORY_TYPE::NONE)] =
				    LIST_ACCESSORY_TYPE::NONE;
			});
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_LIST_ACCESSORY_TYPE: Titanium::UI::LIST_ACCESSORY_TYPE with value '",
				                  listAccessoryType_underlying_type, "' does not exist");
			}

			return listAccessoryType;
		}

		std::underlying_type<LIST_ACCESSORY_TYPE>::type Constants::to_underlying_type(
		    const LIST_ACCESSORY_TYPE& listAccessoryType) TITANIUM_NOEXCEPT
		{
		...
		LIST_ITEM_TEMPLATE Constants::to_LIST_ITEM_TEMPLATE(const std::string& listItemTemplateName) TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_LIST_ITEM_TEMPLATE: Titanium::UI::LIST_ITEM_TEMPLATE with name '",
				                  listItemTemplateName, "' does not exist");
			}

			return listItemTemplate;
		}

		LIST_ITEM_TEMPLATE Constants::to_LIST_ITEM_TEMPLATE(
		    std::underlying_type<LIST_ITEM_TEMPLATE>::type listItemTemplate_underlying_type) TITANIUM_NOEXCEPT
		{
			static std::unordered_map<std::underlying_type<LIST_ITEM_TEMPLATE>::type, LIST_ITEM_TEMPLATE> map;
			static std::once_flag of;
			std::call_once(of, []() {
				map[static_cast<std::underlying_type<LIST_ITEM_TEMPLATE>::type>(LIST_ITEM_TEMPLATE::CONTACTS)] =
				    LIST_ITEM_TEMPLATE::CONTACTS;
				map[static_cast<std::underlying_type<LIST_ITEM_TEMPLATE>::type>(LIST_ITEM_TEMPLATE::DEFAULT)] =
				    LIST_ITEM_TEMPLATE::DEFAULT;
				map[static_cast<std::underlying_type<LIST_ITEM_TEMPLATE>::type>(LIST_ITEM_TEMPLATE::SETTINGS)] =
				    LIST_ITEM_TEMPLATE::SETTINGS;
				map[static_cast<std::underlying_type<LIST_ITEM_TEMPLATE>::type>(LIST_ITEM_TEMPLATE::SUBTITLE)] =
				    LIST_ITEM_TEMPLATE::SUBTITLE;
			});
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_LIST_ITEM_TEMPLATE: Titanium::UI::LIST_ITEM_TEMPLATE with value '",
				                  listItemTemplate_underlying_type, "' does not exist");
			}

			return listItemTemplate;
		}

		std::underlying_type<LIST_ITEM_TEMPLATE>::type Constants::to_underlying_type(
		    const LIST_ITEM_TEMPLATE& listItemTemplate) TITANIUM_NOEXCEPT
		{
		...
		NOTIFICATION_DURATION Constants::to_NOTIFICATION_DURATION(const std::string& notificationDurationName)
		    TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN(
				    "Constants::to_NOTIFICATION_DURATION: Titanium::UI::NOTIFICATION_DURATION with name '",
				    notificationDurationName, "' does not exist");
			}

			return notificationDuration;
		}

		NOTIFICATION_DURATION Constants::to_NOTIFICATION_DURATION(
		    std::underlying_type<NOTIFICATION_DURATION>::type notificationDuration_underlying_type) TITANIUM_NOEXCEPT
		{
			static std::unordered_map<std::underlying_type<NOTIFICATION_DURATION>::type, NOTIFICATION_DURATION> map;
			static std::once_flag of;
			std::call_once(of, []() {
				map[static_cast<std::underlying_type<NOTIFICATION_DURATION>::type>(NOTIFICATION_DURATION::LONG)] =
				    NOTIFICATION_DURATION::LONG;
				map[static_cast<std::underlying_type<NOTIFICATION_DURATION>::type>(NOTIFICATION_DURATION::SHORT)] =
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN(
				    "Constants::to_NOTIFICATION_DURATION: Titanium::UI::NOTIFICATION_DURATION with value '",
				    notificationDuration_underlying_type, "' does not exist");
			}

			return notificationDuration;
		}

		std::underlying_type<NOTIFICATION_DURATION>::type Constants::to_underlying_type(
		    const NOTIFICATION_DURATION& notificationDuration) TITANIUM_NOEXCEPT
		{
		...
		PICKER_TYPE Constants::to_PICKER_TYPE(const std::string& pickerTypeName) TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_PICKER_TYPE: Titanium::UI::PICKER_TYPE with name '", pickerTypeName,
				                  "' does not exist");
			}
		...
		PICKER_TYPE Constants::to_PICKER_TYPE(std::underlying_type<PICKER_TYPE>::type pickerType_underlying_type)
		    TITANIUM_NOEXCEPT
		{
			static std::unordered_map<std::underlying_type<PICKER_TYPE>::type, PICKER_TYPE> map;
			static std::once_flag of;
			std::call_once(of, []() {
				map[static_cast<std::underlying_type<PICKER_TYPE>::type>(PICKER_TYPE::COUNT_DOWN_TIMER)] =
				    PICKER_TYPE::COUNT_DOWN_TIMER;
				map[static_cast<std::underlying_type<PICKER_TYPE>::type>(PICKER_TYPE::DATE)] = PICKER_TYPE::DATE;
				map[static_cast<std::underlying_type<PICKER_TYPE>::type>(PICKER_TYPE::DATE_AND_TIME)] =
				    PICKER_TYPE::DATE_AND_TIME;
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_PICKER_TYPE: Titanium::UI::PICKER_TYPE with value '",
				                  pickerType_underlying_type, "' does not exist");
			}

			return pickerType;
		}

		std::underlying_type<PICKER_TYPE>::type Constants::to_underlying_type(const PICKER_TYPE& pickerType)
		    TITANIUM_NOEXCEPT
		{
		...
		RETURNKEY Constants::to_RETURNKEY(const std::string& returnKeyName) TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_RETURNKEY: Titanium::UI::RETURNKEY with name '", returnKeyName,
				                  "' does not exist");
			}
		...
		RETURNKEY Constants::to_RETURNKEY(std::underlying_type<RETURNKEY>::type returnKey_underlying_type)
		    TITANIUM_NOEXCEPT
		{
			...
			std::call_once(of, []() {
				...
				map[static_cast<std::underlying_type<RETURNKEY>::type>(RETURNKEY::EMERGENCY_CALL)] =
				    RETURNKEY::EMERGENCY_CALL;
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_RETURNKEY: Titanium::UI::RETURNKEY with value '",
				                  returnKey_underlying_type, "' does not exist");
			}

			return returnKey;
		}

		std::underlying_type<RETURNKEY>::type Constants::to_underlying_type(const RETURNKEY& returnKey)
		    TITANIUM_NOEXCEPT
		{
		...
		TEXT_ALIGNMENT Constants::to_TEXT_ALIGNMENT(const std::string& textAlignmentName) TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_TEXT_ALIGNMENT: Titanium::UI::TEXT_ALIGNMENT with name '",
				                  textAlignmentName, "' does not exist");
			}

			return textAlignment;
		}

		TEXT_ALIGNMENT Constants::to_TEXT_ALIGNMENT(
		    std::underlying_type<TEXT_ALIGNMENT>::type textAlignment_underlying_type) TITANIUM_NOEXCEPT
		{
			static std::unordered_map<std::underlying_type<TEXT_ALIGNMENT>::type, TEXT_ALIGNMENT> map;
			static std::once_flag of;
			std::call_once(of, []() {
				map[static_cast<std::underlying_type<TEXT_ALIGNMENT>::type>(TEXT_ALIGNMENT::CENTER)] =
				    TEXT_ALIGNMENT::CENTER;
				map[static_cast<std::underlying_type<TEXT_ALIGNMENT>::type>(TEXT_ALIGNMENT::LEFT)] =
				    TEXT_ALIGNMENT::LEFT;
				map[static_cast<std::underlying_type<TEXT_ALIGNMENT>::type>(TEXT_ALIGNMENT::RIGHT)] =
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_TEXT_ALIGNMENT: Titanium::UI::TEXT_ALIGNMENT with value '",
				                  textAlignment_underlying_type, "' does not exist");
			}

			return textAlignment;
		}

		std::underlying_type<TEXT_ALIGNMENT>::type Constants::to_underlying_type(const TEXT_ALIGNMENT& textAlignment)
		    TITANIUM_NOEXCEPT
		{
		...
		TEXT_AUTOCAPITALIZATION Constants::to_TEXT_AUTOCAPITALIZATION(const std::string& textAutoCapitalizationName)
		    TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN(
				    "Constants::to_TEXT_AUTOCAPITALIZATION: Titanium::UI::TEXT_AUTOCAPITALIZATION with name '",
				    textAutoCapitalizationName, "' does not exist");
			}

			return textAutoCapitalization;
		}

		TEXT_AUTOCAPITALIZATION Constants::to_TEXT_AUTOCAPITALIZATION(std::underlying_type<
		    TEXT_AUTOCAPITALIZATION>::type textAutoCapitalization_underlying_type) TITANIUM_NOEXCEPT
		{
			static std::unordered_map<std::underlying_type<TEXT_AUTOCAPITALIZATION>::type, TEXT_AUTOCAPITALIZATION> map;
			static std::once_flag of;
			std::call_once(of, []() {
				map[static_cast<std::underlying_type<TEXT_AUTOCAPITALIZATION>::type>(TEXT_AUTOCAPITALIZATION::ALL)] =
				    TEXT_AUTOCAPITALIZATION::ALL;
				map[static_cast<std::underlying_type<TEXT_AUTOCAPITALIZATION>::type>(TEXT_AUTOCAPITALIZATION::NONE)] =
				    TEXT_AUTOCAPITALIZATION::NONE;
				map[static_cast<std::underlying_type<TEXT_AUTOCAPITALIZATION>::type>(
				    TEXT_AUTOCAPITALIZATION::SENTENCES)] = TEXT_AUTOCAPITALIZATION::SENTENCES;
				map[static_cast<std::underlying_type<TEXT_AUTOCAPITALIZATION>::type>(TEXT_AUTOCAPITALIZATION::WORDS)] =
				    TEXT_AUTOCAPITALIZATION::WORDS;
			});
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN(
				    "Constants::to_TEXT_AUTOCAPITALIZATION: Titanium::UI::TEXT_AUTOCAPITALIZATION with value '",
				    textAutoCapitalization_underlying_type, "' does not exist");
			}

			return textAutoCapitalization;
		}

		std::underlying_type<TEXT_AUTOCAPITALIZATION>::type Constants::to_underlying_type(
		    const TEXT_AUTOCAPITALIZATION& textAutoCapitalization) TITANIUM_NOEXCEPT
		{
		...
		TEXT_VERTICAL_ALIGNMENT Constants::to_TEXT_VERTICAL_ALIGNMENT(const std::string& textVerticalAlignmentName)
		    TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN(
				    "Constants::to_TEXT_VERTICAL_ALIGNMENT: Titanium::UI::TEXT_VERTICAL_ALIGNMENT with name '",
				    textVerticalAlignmentName, "' does not exist");
			}

			return textVerticalAlignment;
		}

		TEXT_VERTICAL_ALIGNMENT Constants::to_TEXT_VERTICAL_ALIGNMENT(
		    std::underlying_type<TEXT_VERTICAL_ALIGNMENT>::type textVerticalAlignment_underlying_type) TITANIUM_NOEXCEPT
		{
			static std::unordered_map<std::underlying_type<TEXT_VERTICAL_ALIGNMENT>::type, TEXT_VERTICAL_ALIGNMENT> map;
			static std::once_flag of;
			std::call_once(of, []() {
				map[static_cast<std::underlying_type<TEXT_VERTICAL_ALIGNMENT>::type>(TEXT_VERTICAL_ALIGNMENT::BOTTOM)] =
				    TEXT_VERTICAL_ALIGNMENT::BOTTOM;
				map[static_cast<std::underlying_type<TEXT_VERTICAL_ALIGNMENT>::type>(TEXT_VERTICAL_ALIGNMENT::CENTER)] =
				    TEXT_VERTICAL_ALIGNMENT::CENTER;
				map[static_cast<std::underlying_type<TEXT_VERTICAL_ALIGNMENT>::type>(TEXT_VERTICAL_ALIGNMENT::TOP)] =
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN(
				    "Constants::to_TEXT_VERTICAL_ALIGNMENT: Titanium::UI::TEXT_VERTICAL_ALIGNMENT with value '",
				    textVerticalAlignment_underlying_type, "' does not exist");
			}

			return textVerticalAlignment;
		}

		std::underlying_type<TEXT_VERTICAL_ALIGNMENT>::type Constants::to_underlying_type(
		    const TEXT_VERTICAL_ALIGNMENT& textVerticalAlignment) TITANIUM_NOEXCEPT
		{
		...
		URL_ERROR Constants::to_URL_ERROR(const std::string& urlErrorName) TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_URL_ERROR: Titanium::UI::URL_ERROR with name '", urlErrorName,
				                  "' does not exist");
			}
		...
		URL_ERROR Constants::to_URL_ERROR(std::underlying_type<URL_ERROR>::type urlError_underlying_type)
		    TITANIUM_NOEXCEPT
		{
			static std::unordered_map<std::underlying_type<URL_ERROR>::type, URL_ERROR> map;
			static std::once_flag of;
			std::call_once(of, []() {
				map[static_cast<std::underlying_type<URL_ERROR>::type>(URL_ERROR::AUTHENTICATION)] =
				    URL_ERROR::AUTHENTICATION;
				...
				map[static_cast<std::underlying_type<URL_ERROR>::type>(URL_ERROR::FILE_NOT_FOUND)] =
				    URL_ERROR::FILE_NOT_FOUND;
				map[static_cast<std::underlying_type<URL_ERROR>::type>(URL_ERROR::HOST_LOOKUP)] =
				    URL_ERROR::HOST_LOOKUP;
				map[static_cast<std::underlying_type<URL_ERROR>::type>(URL_ERROR::REDIRECT_LOOP)] =
				    URL_ERROR::REDIRECT_LOOP;
				...
				map[static_cast<std::underlying_type<URL_ERROR>::type>(URL_ERROR::UNSUPPORTED_SCHEME)] =
				    URL_ERROR::UNSUPPORTED_SCHEME;
			});
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_URL_ERROR: Titanium::UI::URL_ERROR with value '",
				                  urlError_underlying_type, "' does not exist");
			}
		...
		LAYOUT Constants::to_LAYOUT(const std::string& layoutName) TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_LAYOUT: Titanium::UI::LAYOUT with name '", layoutName,
				                  "' does not exist");
			}
		...
		LAYOUT Constants::to_LAYOUT(std::underlying_type<LAYOUT>::type layout_underlying_type) TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_LAYOUT: Titanium::UI::LAYOUT with value '", layout_underlying_type,
				                  "' does not exist");
			}
		...
		TEXT_STYLE Constants::to_TEXT_STYLE(const std::string& textStyleName) TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_TEXT_STYLE: Titanium::UI::TEXT_STYLE with name '", textStyleName,
				                  "' does not exist");
			}
		...
		TEXT_STYLE Constants::to_TEXT_STYLE(std::underlying_type<TEXT_STYLE>::type textStyle_underlying_type)
		    TITANIUM_NOEXCEPT
		{
			...
			std::call_once(of, []() {
				...
				map[static_cast<std::underlying_type<TEXT_STYLE>::type>(TEXT_STYLE::SUBHEADLINE)] =
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_TEXT_STYLE: Titanium::UI::TEXT_STYLE with value '",
				                  textStyle_underlying_type, "' does not exist");
			}

			return textStyle;
		}

		std::underlying_type<TEXT_STYLE>::type Constants::to_underlying_type(const TEXT_STYLE& textStyle)
		    TITANIUM_NOEXCEPT
		{
		...
		UNIT Constants::to_UNIT(std::underlying_type<UNIT>::type unit_underlying_type) TITANIUM_NOEXCEPT
		{
			...
			if (position != map.end()) {
				...
				TITANIUM_LOG_WARN("Constants::to_UNIT: Titanium::UI::UNIT with value '", unit_underlying_type,
				                  "' does not exist");
			}
