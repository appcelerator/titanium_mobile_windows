...
namespace Titanium
{
	namespace detail
	{
		...
		TITANIUMKIT_EXPORT void ThrowRuntimeError(const std::string& internal_component_name,
		                                          const std::string& message);
		TITANIUMKIT_EXPORT void ThrowInvalidArgument(const std::string& internal_component_name,
		                                             const std::string& message);
	}
