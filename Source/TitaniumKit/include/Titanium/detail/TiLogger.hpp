...
namespace Titanium
{
	namespace detail
	{
		...
		enum class TITANIUMKIT_EXPORT TiLoggerSeverityType { Ti_TRACE,
			                                                 Ti_DEBUG,
			                                                 Ti_INFO,
			                                                 Ti_WARN,
			                                                 Ti_ERROR };
		...
		class TiLogger final
		{
		   ...
		   private:
			...
			struct deleter
			{
				void operator()(TiLogger* ptr) { delete ptr; }
			};
		...
		std::shared_ptr<TiLogger<TiLoggerPolicy>> TiLogger<TiLoggerPolicy>::Instance()
		{
			...
			std::call_once(of, [] {
				instance = std::shared_ptr<TiLogger<TiLoggerPolicy>>(new TiLogger<TiLoggerPolicy>("TitaniumKit.log"),
				                                                     deleter{});
			});
...
#define TITANIUM_LOG_TRACE \
	Titanium::detail::TiLogger_t::Instance()->Print<Titanium::detail::TiLoggerSeverityType::Ti_TRACE>
#define TITANIUM_LOG_DEBUG \
	Titanium::detail::TiLogger_t::Instance()->Print<Titanium::detail::TiLoggerSeverityType::Ti_DEBUG>
#define TITANIUM_LOG_INFO \
	Titanium::detail::TiLogger_t::Instance()->Print<Titanium::detail::TiLoggerSeverityType::Ti_INFO>
#define TITANIUM_LOG_WARN \
	Titanium::detail::TiLogger_t::Instance()->Print<Titanium::detail::TiLoggerSeverityType::Ti_WARN>
#define TITANIUM_LOG_ERROR \
	Titanium::detail::TiLogger_t::Instance()->Print<Titanium::detail::TiLoggerSeverityType::Ti_ERROR>
#else
#define TITANIUM_LOG_TRACE(...)
#define TITANIUM_LOG_DEBUG(...)
#define TITANIUM_LOG_INFO(...)
