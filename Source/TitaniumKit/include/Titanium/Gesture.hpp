...
namespace Titanium
{
	...
	*/
	class TITANIUMKIT_EXPORT Gesture : public Module, public JSExport<Gesture>
	{
		...
		*/
		virtual JSValue getLandscape_ArgumentValidator(const std::vector<JSValue>& arguments,
		...
		*/
		virtual JSValue getPortrait_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                              JSObject& this_object) TITANIUM_NOEXCEPT final;
		...
		*/
		virtual JSValue getOrientation_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                                 JSObject& this_object) TITANIUM_NOEXCEPT final;
		...
		*/
		virtual JSValue isFaceDown_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                             JSObject& this_object) TITANIUM_NOEXCEPT final;
		...
		*/
		virtual JSValue isFaceUp_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                           JSObject& this_object) TITANIUM_NOEXCEPT final;
		virtual JSValue isLandscape_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                              JSObject& this_object) TITANIUM_NOEXCEPT final;
		virtual JSValue isPortrait_ArgumentValidator(const std::vector<JSValue>& arguments,
		                                             JSObject& this_object) TITANIUM_NOEXCEPT final;
