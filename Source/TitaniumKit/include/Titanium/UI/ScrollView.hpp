	...
	namespace UI
	{
		...
		class TITANIUMKIT_EXPORT ScrollView : public View, public JSExport<ScrollView>
		{
		   public:
			...
			virtual JSValue setContentWidthArgumentValidator(const std::vector<JSValue>&,
			                                                 JSObject&) TITANIUM_NOEXCEPT final;
			virtual JSValue getContentWidthArgumentValidator(const std::vector<JSValue>&,
			                                                 JSObject&) TITANIUM_NOEXCEPT final;
			virtual JSValue setContentHeightArgumentValidator(const std::vector<JSValue>&,
			                                                  JSObject&) TITANIUM_NOEXCEPT final;
			virtual JSValue getContentHeightArgumentValidator(const std::vector<JSValue>&,
			                                                  JSObject&) TITANIUM_NOEXCEPT final;

			virtual JSValue scrollToArgumentValidator(const std::vector<JSValue>&, JSObject&) TITANIUM_NOEXCEPT final;
			virtual JSValue scrollToBottomArgumentValidator(const std::vector<JSValue>&,
			                                                JSObject&) TITANIUM_NOEXCEPT final;
			...
			virtual JSValue setScrollingEnabledArgumentValidator(const std::vector<JSValue>&,
			                                                     JSObject&) TITANIUM_NOEXCEPT final;
			virtual JSValue getScrollingEnabledArgumentValidator(const std::vector<JSValue>&,
			                                                     JSObject&) TITANIUM_NOEXCEPT final;

			virtual JSValue get_ShowHorizontalScrollIndicatorArgumentValidator() const TITANIUM_NOEXCEPT final;
			virtual bool set_ShowHorizontalScrollIndicatorArgumentValidator(const JSValue& width)
			    TITANIUM_NOEXCEPT final;
			virtual JSValue setShowHorizontalScrollIndicatorArgumentValidator(const std::vector<JSValue>&,
			                                                                  JSObject&) TITANIUM_NOEXCEPT final;
			virtual JSValue getShowHorizontalScrollIndicatorArgumentValidator(const std::vector<JSValue>&,
			                                                                  JSObject&) TITANIUM_NOEXCEPT final;
			...
			virtual JSValue setShowVerticalScrollIndicatorArgumentValidator(const std::vector<JSValue>&,
			                                                                JSObject&) TITANIUM_NOEXCEPT final;
			virtual JSValue getShowVerticalScrollIndicatorArgumentValidator(const std::vector<JSValue>&,
			                                                                JSObject&) TITANIUM_NOEXCEPT final;
