...
#ifndef _TITANIUM_UI_UIBASE_HPP_
#define _TITANIUM_UI_UIBASE_HPP_
...
namespace Titanium
{
	namespace UI
	{
		...
		using NativeChildPtr_t = std::shared_ptr<Titanium::UI::UIBase>;
		...
		*/
		class TITANIUMKIT_EXPORT UIBase : public Module, public JSExport<UIBase>
		{
		public:
			/*!
			  @method
			...
			*/
			...
			UIBase(const JSContext&, const std::vector<JSValue>& arguments = {}) TITANIUM_NOEXCEPT;

			virtual ~UIBase() TITANIUM_NOEXCEPT;  //= default;
...
#endif  // _TITANIUM_UI_UIBASE_HPP_
