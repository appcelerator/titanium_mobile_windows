	...
	namespace UI
	{
		...
		class TITANIUMKIT_EXPORT View : public Module, public JSExport<View>
		{
			...
			*/
			...
			virtual JSValue addArgumentValidator(const std::vector<JSValue>& arguments,
			                                     JSObject& this_object) TITANIUM_NOEXCEPT final;
			virtual JSValue hideArgumentValidator(const std::vector<JSValue>& arguments,
			                                      JSObject& this_object) TITANIUM_NOEXCEPT final;
			virtual JSValue showArgumentValidator(const std::vector<JSValue>& arguments,
			                                      JSObject& this_object) TITANIUM_NOEXCEPT final;
