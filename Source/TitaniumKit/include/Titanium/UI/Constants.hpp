...
namespace Titanium
{
	namespace UI
	{
		/*!
		 ...
		 constant rate.
		 */
		enum class TITANIUMKIT_EXPORT ANIMATION_CURVE { EASE_IN,
			                                            EASE_IN_OUT,
			                                            EASE_OUT,
			                                            LINEAR };
		...
		/*!
		 ...
		 field.
		 */
		enum class TITANIUMKIT_EXPORT INPUT_BORDERSTYLE { BEZEL,
			                                              LINE,
			                                              NONE,
			                                              ROUNDED };
		...
		/*!
		 ...
		 focus.
		 */
		enum class TITANIUMKIT_EXPORT INPUT_BUTTONMODE { ALWAYS,
			                                             NEVER,
			                                             ONBLUR,
			                                             ONFOCUS };
		...
		/*!
		 ...
		 appearance.
		 */
		enum class TITANIUMKIT_EXPORT KEYBOARD_APPEARANCE { ALERT,
			                                                DEFAULT };
		...
		/*!
		 ...
		 in a list view.
		 */
		enum class TITANIUMKIT_EXPORT LIST_ACCESSORY_TYPE { CHECKMARK,
			                                                DETAIL,
			                                                DISCLOSURE,
			                                                NONE };
		 ...
		 */
		enum class TITANIUMKIT_EXPORT LIST_ITEM_TEMPLATE { CONTACTS,
			                                               DEFAULT,
			                                               SETTINGS,
			                                               SUBTITLE };
		...
		/*!
		 ...
		 notification.
		 */
		enum class TITANIUMKIT_EXPORT NOTIFICATION_DURATION { LONG,
			                                                  SHORT };
		 ...
		 */
		enum class TITANIUMKIT_EXPORT PICKER_TYPE { COUNT_DOWN_TIMER,
			                                        DATE,
			                                        DATE_AND_TIME,
			                                        PLAIN,
			                                        TIME };
		 ...
		 */
		enum class TITANIUMKIT_EXPORT TEXT_ALIGNMENT { CENTER,
			                                           LEFT,
			                                           RIGHT };
		...
		/*!
		 ...
		 the input field.
		 */
		enum class TITANIUMKIT_EXPORT TEXT_AUTOCAPITALIZATION { ALL,
			                                                    NONE,
			                                                    SENTENCES,
			                                                    WORDS };
		 ...
		 */
		enum class TITANIUMKIT_EXPORT TEXT_VERTICAL_ALIGNMENT { BOTTOM,
			                                                    CENTER,
			                                                    TOP };
		 ...
		 */
		enum class TITANIUMKIT_EXPORT LAYOUT { FILL,
			                                   INHERIT,
			                                   SIZE };
		 ...
		 */
		enum class TITANIUMKIT_EXPORT TEXT_STYLE { BODY,
			                                       CAPTION1,
			                                       CAPTION2,
			                                       FOOTNOTE,
			                                       HEADLINE,
		 ...
		 */
		enum class TITANIUMKIT_EXPORT UNIT { CM,
			                                 DIP,
			                                 IN,
			                                 MM,
			                                 PX };
	...
	namespace UI
	{
		class TITANIUMKIT_EXPORT Constants final
		{
		   public:
			...
			static std::underlying_type<ANIMATION_CURVE>::type to_underlying_type(const ANIMATION_CURVE&)
			    TITANIUM_NOEXCEPT;
			...
			static std::underlying_type<AUTOLINK>::type to_underlying_type(const std::unordered_set<AUTOLINK>&)
			    TITANIUM_NOEXCEPT;
			...
			static std::unordered_set<EXTEND_EDGE> to_EXTEND_EDGE(std::underlying_type<EXTEND_EDGE>::type)
			    TITANIUM_NOEXCEPT;
			static std::underlying_type<EXTEND_EDGE>::type to_underlying_type(
			...
			static INPUT_BORDERSTYLE to_INPUT_BORDERSTYLE(std::underlying_type<INPUT_BORDERSTYLE>::type)
			    TITANIUM_NOEXCEPT;
			static std::underlying_type<INPUT_BORDERSTYLE>::type to_underlying_type(const INPUT_BORDERSTYLE&)
			    TITANIUM_NOEXCEPT;
			...
			static std::underlying_type<INPUT_BUTTONMODE>::type to_underlying_type(const INPUT_BUTTONMODE&)
			    TITANIUM_NOEXCEPT;

			static std::string to_string(const KEYBOARD_APPEARANCE&) TITANIUM_NOEXCEPT;
			static KEYBOARD_APPEARANCE to_KEYBOARD_APPEARANCE(const std::string& keyboardAppearanceName)
			    TITANIUM_NOEXCEPT;
			static KEYBOARD_APPEARANCE to_KEYBOARD_APPEARANCE(std::underlying_type<KEYBOARD_APPEARANCE>::type)
			    TITANIUM_NOEXCEPT;
			static std::underlying_type<KEYBOARD_APPEARANCE>::type to_underlying_type(const KEYBOARD_APPEARANCE&)
			    TITANIUM_NOEXCEPT;
			...
			static LIST_ACCESSORY_TYPE to_LIST_ACCESSORY_TYPE(const std::string& listAccessoryTypeName)
			    TITANIUM_NOEXCEPT;
			static LIST_ACCESSORY_TYPE to_LIST_ACCESSORY_TYPE(std::underlying_type<LIST_ACCESSORY_TYPE>::type)
			    TITANIUM_NOEXCEPT;
			static std::underlying_type<LIST_ACCESSORY_TYPE>::type to_underlying_type(const LIST_ACCESSORY_TYPE&)
			    TITANIUM_NOEXCEPT;
			...
			static LIST_ITEM_TEMPLATE to_LIST_ITEM_TEMPLATE(std::underlying_type<LIST_ITEM_TEMPLATE>::type)
			    TITANIUM_NOEXCEPT;
			static std::underlying_type<LIST_ITEM_TEMPLATE>::type to_underlying_type(const LIST_ITEM_TEMPLATE&)
			    TITANIUM_NOEXCEPT;

			static std::string to_string(const NOTIFICATION_DURATION&) TITANIUM_NOEXCEPT;
			static NOTIFICATION_DURATION to_NOTIFICATION_DURATION(const std::string& notificationDurationName)
			    TITANIUM_NOEXCEPT;
			static NOTIFICATION_DURATION to_NOTIFICATION_DURATION(std::underlying_type<NOTIFICATION_DURATION>::type)
			    TITANIUM_NOEXCEPT;
			static std::underlying_type<NOTIFICATION_DURATION>::type to_underlying_type(const NOTIFICATION_DURATION&)
			    TITANIUM_NOEXCEPT;
			...
			static std::underlying_type<TEXT_ALIGNMENT>::type to_underlying_type(const TEXT_ALIGNMENT&)
			    TITANIUM_NOEXCEPT;

			static std::string to_string(const TEXT_AUTOCAPITALIZATION&) TITANIUM_NOEXCEPT;
			static TEXT_AUTOCAPITALIZATION to_TEXT_AUTOCAPITALIZATION(const std::string& textAutoCapitalizationName)
			    TITANIUM_NOEXCEPT;
			static TEXT_AUTOCAPITALIZATION to_TEXT_AUTOCAPITALIZATION(
			    std::underlying_type<TEXT_AUTOCAPITALIZATION>::type) TITANIUM_NOEXCEPT;
			static std::underlying_type<TEXT_AUTOCAPITALIZATION>::type to_underlying_type(
			    const TEXT_AUTOCAPITALIZATION&) TITANIUM_NOEXCEPT;

			static std::string to_string(const TEXT_VERTICAL_ALIGNMENT&) TITANIUM_NOEXCEPT;
			static TEXT_VERTICAL_ALIGNMENT to_TEXT_VERTICAL_ALIGNMENT(const std::string& textVerticalAlignmentName)
			    TITANIUM_NOEXCEPT;
			static TEXT_VERTICAL_ALIGNMENT to_TEXT_VERTICAL_ALIGNMENT(
			    std::underlying_type<TEXT_VERTICAL_ALIGNMENT>::type) TITANIUM_NOEXCEPT;
			static std::underlying_type<TEXT_VERTICAL_ALIGNMENT>::type to_underlying_type(
			    const TEXT_VERTICAL_ALIGNMENT&) TITANIUM_NOEXCEPT;
