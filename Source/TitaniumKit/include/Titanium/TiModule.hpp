...
namespace Titanium
{
	...
	class TITANIUMKIT_EXPORT TiModule : public Module, public JSExport<TiModule>
	{
	   public:
		...
		virtual JSValue getVersionArgumentValidator(const std::vector<JSValue>& arguments,
		...
		virtual JSValue getBuildDateArgumentValidator(const std::vector<JSValue>& arguments,
		                                              JSObject& this_object) TITANIUM_NOEXCEPT final;
		virtual JSValue get_buildHash_ArgumentValidator() const TITANIUM_NOEXCEPT final;
		virtual JSValue getBuildHashArgumentValidator(const std::vector<JSValue>& arguments,
		                                              JSObject& this_object) TITANIUM_NOEXCEPT final;
		...
		virtual JSValue getUserAgentArgumentValidator(const std::vector<JSValue>& arguments,
		                                              JSObject& this_object) TITANIUM_NOEXCEPT final;
		virtual JSValue setUserAgentArgumentValidator(const std::vector<JSValue>& arguments,
		                                              JSObject& this_object) TITANIUM_NOEXCEPT final;

		virtual JSValue createBufferArgumentValidator(const std::vector<JSValue>& arguments,
