...
namespace Titanium
{
	namespace LayoutEngine
	{
		...
		enum LayoutType { Composite = 0,
			              Horizontal,
			              Vertical };
		enum ElementAlignment { Start = 0,
			                    Center,
			                    End };
		...
		inline bool RectIsEmpty(Rect rect) { return rect.x == 0 && rect.y == 0 && rect.width == 0 && rect.height == 0; }
